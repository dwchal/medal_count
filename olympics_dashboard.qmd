...
#| color: info
list(
  value = if (nrow(usa_medal_results) > 0) nrow(usa_medal_results) else usa_current_total
)
```
...
#| color: warning
list(
  value = if (nrow(usa_medal_results) > 0) sum(usa_medal_results$medal == "Gold") else usa_current_gold
)
```
...
#| color: light
list(
  value = if (nrow(usa_medal_results) > 0) sum(usa_medal_results$medal == "Silver") else usa_current_silver
)
```
...
#| color: danger
list(
  value = if (nrow(usa_medal_results) > 0) sum(usa_medal_results$medal == "Bronze") else usa_current_bronze
)
```
