...
plot_ly(x = mc_results$total, type = "histogram",
  ...
  layout(
    title = list(text = ""),
    xaxis = list(title = "Total Medals"),
    yaxis = list(title = "Frequency (10,000 simulations)"),
    showlegend = TRUE,
    legend = list(orientation = "h", y = -0.15),
    margin = list(t = 20),
    bargap = 0.05
...
plot_ly(data = country_predictions %>% head(10),
  ...
  layout(
    title = list(text = ""),
    xaxis = list(title = "Predicted Medals"),
    yaxis = list(title = ""),
    barmode = "stack",
...
plot_ly(data = medal_timing,
  ...
  layout(
    title = list(text = ""),
    xaxis = list(title = "", tickangle = 45),
    yaxis = list(title = "Cumulative Medals", side = "left"),
