...
medal_standings <- tibble(
  ...
  country = c("Norway", "Germany", "USA", "Canada", "Netherlands",
              "Sweden", "Austria", "Switzerland", "ROC", "France"),
  flag = c("🇳🇴", "🇩🇪", "🇺🇸", "🇨🇦", "🇳🇱", "🇸🇪", "🇦🇹", "🇨🇭", "🏳️", "🇫🇷"),
  gold = c(12, 10, usa_current_gold, 6, 5, 5, 4, 4, 3, 3),
  silver = c(8, 7, usa_current_silver, 8, 6, 4, 5, 3, 4, 3),
  bronze = c(10, 8, usa_current_bronze, 7, 4, 6, 3, 5, 5, 4)
) %>%
...
#| color: success
list(
  value = paste("#", medal_standings %>% filter(country == "USA") %>% pull(rank))
)
```
